...
public final class VehicleShortcuts {
    ...
    private static final Shortcut[] ALL = {
            ...
            new Shortcut("chargepoint", R.string.oem_charge_point,
                    VEHICLE, CHARGE_ACTIVITY, "module", "ChargePointManagementFragment"),
            new Shortcut("chargepoint_bt", R.string.oem_charge_point_bluetooth,
                    VEHICLE, CHARGE_ACTIVITY, "module", "ChargePointBluetoothFragment"),
            new Shortcut("chargepoint_connect", R.string.oem_charge_point_connect,
                    VEHICLE, CHARGE_ACTIVITY, "module", "ChargePointConnectFragment"),
